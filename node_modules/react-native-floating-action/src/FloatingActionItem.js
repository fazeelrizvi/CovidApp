...
class FloatingActionItem extends Component {
      ...
      return (
        <View
          ...
          style={[
            ...
            shadow,
            textContainerStyle
          ,{height:25, backgroundColor:'#fff', justifyContent:'center'}]}
        >
          <Text
            style={[
              styles.text,
  ...
  renderButton() {
    ...
    return (
      <View
        key="button"
        style={[styles.button, propStyles, shadow,{width:45, height:45, borderRadius:10, backgroundColor:'#39867E'}]}
      >
        {React.isValidElement(icon) ? (
          icon
        ) : (
          <Image style={[iconStyle, {tintColor: tintColor}, {width:30, height:30}]} source={icon} />
        )}
      </View>
    );
  }
